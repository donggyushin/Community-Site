...
<div class="container">
  ...
  <thead class="thead-dark">
    <tr>
      <th scope="col"></th>
      <th scope="col">Board Writing Form</th>
      <th scope="col"></th>
      <th scope="col"></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td><input type="text" name="boardTitle" class="form-control" placeholder="Input Title...." maxlength="50"></td>
    </tr>
    <tr>
      <th scope="row">Content: </th>
      <td><textarea name="boardContent" class="form-control" placeholder="Input Content..." rows="10" maxlength="2000" ></textarea></td>
    </tr>
    <tr>
